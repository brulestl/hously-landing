                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 items-center mt-10">
                        <div className="md:text-start text-center">
                            <h1 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">{t('index_nine.headline')}</h1>
                            <p className="text-xl max-w-xl">{t('index_nine.subheadline')}</p>
                                        ...
                                        <form action="#">
                                            <div className="registration-form text-dark text-start">
                                                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                                    <div>
                                                        <label className="form-label text-slate-900 dark:text-white font-medium">{t('index_nine.form.search_label')}</label>
                                                    ...
                                                    <div>
                                                        <label className="form-label text-slate-900 dark:text-white font-medium">{t('index_nine.form.select_categories_label')}</label>
                                                        <div className="filter-search-form relative filter-border mt-2">
                                                    ...
                                                    <div>
                                                        <label className="form-label text-slate-900 dark:text-white font-medium">{t('index_nine.form.min_price_label')}</label>
                                                        <div className="filter-search-form relative filter-border mt-2">
                                                    ...
                                                    <div className="md:mt-8">
                                                        <input type="submit" className="btn bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white searchbtn submit-btn w-full !h-[60px] rounded lg:rounded-none" value={t('index_nine.form.search_button')} />
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
            ...
            <section className="relative md:py-24 py-16">
                <div className="container relative">
                    <div className="grid grid-cols-1 pb-8">
                        <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">{t('index_nine.sections.listing_categories')}</h3>
                        <p className="text-slate-400 max-w-xl">{t('index_nine.subheadline')}</p>
                    </div>
                    <Categories/>
                </div>
            </section>
