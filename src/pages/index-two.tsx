                ...
                <div className="container relative z-3">
                    <div className="grid grid-cols-1 mt-10">
                        <div className="text-center">
                            ...
                            <p className="text-white/70 text-xl max-w-xl mx-auto">Moderna platforma za kupovinu, prodaju ili iznajmljivanje nekretnina bez skrivenih 'administrativnih' naknada.</p>
                        </div>
