...
export default function Faq() {
    ...
    const [activeGeneral, setGeneralIndex] = useState<number | null>(0);
    const [activePayment, setPaymentIndex] = useState<number | null>(0);
    const [activeSupport, setSupportIndex] = useState<number | null>(0);
    ...
    const toggleGeneral = (index:number | null) => {
    ...
    const togglePayment = (index:number | null) => {
    ...
    const toggleSupport = (index:number | null) => {
                        ...
                        <div className="lg:col-span-4 md:col-span-5">
                            <div className="rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700 p-6 sticky top-20">
                                <ul className="list-unstyled sidebar-nav mb-0 py-0" id="navmenu-nav">
                                    <li className="navbar-item p-0"><Link to="tech" spy={true} activeClass="active"
                                        smooth={true}
