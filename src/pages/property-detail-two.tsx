                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        ...
                        <ul className="py-6 flex items-center list-none">
                            <li className="flex items-center lg:me-6 me-4">
                                ...
                                <span className="lg:text-xl">743m²</span>
                            </li>
                    ...
                    <div className="lg:col-span-4 md:col-span-5">
                        <div className="sticky top-20">
                            ...
                            <div className="mt-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Link to="/contact" className="btn bg-transparent hover:bg-green-600 border border-green-600 text-green-600 hover:text-white rounded-md"><FiPhone className="align-middle me-2"/> Contact us</Link>
                                </div>
                            </div>
                        </div>
                    </div>
