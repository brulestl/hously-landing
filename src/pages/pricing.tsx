                                    ...
                                    <div className="p-6">
                                        ...
                                        <ul className="list-none">
                                            {item.features.map((el,index)=>{
                                                return(
                                                    <li key={index} className="text-slate-400 mt-2 flex items-center"><span className="text-green-600 text-lg me-2 "><BsCheckCircle className="align-middle"/></span>{el}</li>
                                                )
                                            })}
                                        </ul>
                                        <Link to="#" className="btn bg-green-600 hover:bg-green-700 border-green-600 dark:border-green-600 text-white rounded-md w-full mt-4">Get Started</Link>
                                    </div>
                                </div>
                            )
                        })}
