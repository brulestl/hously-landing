...
const FooterLight = () => {
  ...
  useEffect(() => {
    // Add any necessary translations here
  }, [t]);
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="footer-head">
              <h4 className="text-dark mb-4">About Us</h4>
              <p className="text-muted">{t('footer.platform_description')}</p>
            </div>
          </div>
          <div className="col-lg-2 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
            <div className="footer-head">
              <h4 className="text-dark mb-4">{t('footer.company')}</h4>
          ...
          <div className="col-lg-2 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
            <div className="footer-head">
              <h4 className="text-dark mb-4">{t('footer.useful_links')}</h4>
              <ul className="list-unstyled footer-list mt-4">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="text-center">
                <p className="mb-0 text-muted">{t('footer.copyright', { year: new Date().getFullYear() })}</p>
              </div>
            </div>
          </div>
        </div>
